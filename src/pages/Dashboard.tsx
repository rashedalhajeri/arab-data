...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-sky-50 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-indigo-950 dark:to-slate-900" dir="rtl">
      {/* الشريط الجانبي */}
      <GallerySidebar />
